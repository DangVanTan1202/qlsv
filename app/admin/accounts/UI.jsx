...
export default function AccountUI({
  ...
  const filteredUsers = users.filter((u) =>
    `${u.tenTaiKhoan} ${u.hoTen}`.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      <div className="flex-1 px-8 py-6">
        ...
        <h2 className="text-3xl font-semibold text-orange-600 mb-6">Quản lý tài khoản</h2>
            ...
            <tbody>
              {filteredUsers.map((u) => (
                <tr key={u.id} className="hover:bg-gray-50">
                  ...
                  <td className="p-3">{loaiTKs.find((l) => l.Id === u.LoaiTK_Id)?.Name}</td>
